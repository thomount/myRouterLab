...
ip netns exec PC1 ethtool -K veth-PC1 tx off
ip netns exec R1 ethtool -K veth-R1-left tx off
ip netns exec R1 ethtool -K veth-R1-right tx off
ip netns exec R2-Mine ethtool -K eth1 tx off
ip netns exec R2-Mine ethtool -K eth2 tx off
ip netns exec R3 ethtool -K veth-R3-left tx off
ip netns exec R3 ethtool -K veth-R3-right tx off
ip netns exec PC2 ethtool -K veth-PC2-left tx off